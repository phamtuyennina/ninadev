...
use NINA\Database\Concerns\BuildsQueries;
use NINA\Database\Concerns\ExplainsQueries;
use NINA\Database\ConnectionInterface;
use NINA\Database\Eloquent\Builder as EloquentBuilder;
use NINA\Database\Eloquent\Relations\Relation;
use NINA\Database\Query\Grammars\Grammar;
use NINA\Database\Query\Processors\Processor;
...
class Builder implements BuilderContract
{
     ...
     *
     * @var \NINA\Database\ConnectionInterface
     */
    public $connection;
     ...
     *
     * @var \NINA\Database\Query\Grammars\Grammar
     */
    public $grammar;
     ...
     *
     * @var \NINA\Database\Query\Processors\Processor
     */
    public $processor;
     ...
     *
     * @var \NINA\Database\Query\Expression|string
     */
    public $from;
     ...
     *
     * @var \NINA\Database\Query\IndexHint
     */
    public $indexHint;
     ...
     * @param  \NINA\Database\Query\Grammars\Grammar|null  $grammar
     * @param  \NINA\Database\Query\Processors\Processor|null  $processor
     * @return void
     */
     ...
     *
     * @param  \Closure|\NINA\Database\Query\Builder|\NINA\Database\Eloquent\Builder|string  $query
     * @param  string  $as
     * @return $this
     *
     ...
     *
     * @param  \Closure|\NINA\Database\Query\Builder|\NINA\Database\Eloquent\Builder|string  $table
     ...
     *
     * @param  \NINA\Database\Query\Builder  $parentQuery
     * @param  string  $type
     * @param  string  $table
     * @return \NINA\Database\Query\JoinClause
     */
     ...
     * @param  string  $type
     * @param  string  $table
     * @return \NINA\Database\Query\JoinLateralClause
     */
     ...
     *
     * @return \NINA\Database\Query\Builder
     */
     ...
     * @param  \Illuminate\Contracts\Database\Query\Expression|string  $column
     * @param  string  $operator
     * @param  \Closure||\NINA\Database\Query\Builder|\NINA\Database\Eloquent\Builder  $callback
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \Closure|\NINA\Database\Query\Builder|\NINA\Database\Eloquent\Builder|\Illuminate\Contracts\Database\Query\Expression|string  $column
     ...
     *
     * @param  \Closure|\NINA\Database\Query\Builder|\Illuminate\Contracts\Database\Query\Expression|string  $column
     * @return $this
     */
     ...
     *
     * @param  \Closure|\NINA\Database\Query\Builder|\Illuminate\Contracts\Database\Query\Expression|string|null  $column
     * @param  string  $direction
     * @return $this
     */
     ...
     *
     * @param  \Closure|\NINA\Database\Query\Builder|\NINA\Database\Eloquent\Builder  $query
     * @param  bool  $all
     * @return $this
     */
     ...
     * @return mixed
     *
     * @throws \NINA\Database\RecordsNotFoundException
     * @throws \NINA\Database\MultipleRecordsFoundException
     */
     ...
     *
     * @return \NINA\Database\ConnectionInterface
     */
     ...
     *
     * @return \NINA\Database\Query\Processors\Processor
     */
     ...
     *
     * @return \NINA\Database\Query\Grammars\Grammar
     */
