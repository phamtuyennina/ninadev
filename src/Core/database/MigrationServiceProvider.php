...
use NINA\Database\Console\Migrations\FreshCommand;
use NINA\Database\Console\Migrations\InstallCommand;
use NINA\Database\Console\Migrations\MigrateCommand;
use NINA\Database\Console\Migrations\MigrateMakeCommand;
use NINA\Database\Console\Migrations\RefreshCommand;
use NINA\Database\Console\Migrations\ResetCommand;
use NINA\Database\Console\Migrations\RollbackCommand;
use NINA\Database\Console\Migrations\StatusCommand;
use NINA\Database\Migrations\DatabaseMigrationRepository;
use NINA\Database\Migrations\MigrationCreator;
use NINA\Database\Migrations\Migrator;
