...
use NINA\Database\Events\QueryExecuted;
use NINA\Database\Events\StatementPrepared;
use NINA\Database\Events\TransactionBeginning;
use NINA\Database\Events\TransactionCommitted;
use NINA\Database\Events\TransactionCommitting;
use NINA\Database\Events\TransactionRolledBack;
use NINA\Database\Query\Builder as QueryBuilder;
use NINA\Database\Query\Expression;
use NINA\Database\Query\Grammars\Grammar as QueryGrammar;
use NINA\Database\Query\Processors\Processor;
use NINA\Database\Schema\Builder as SchemaBuilder;
...
class Connection implements ConnectionInterface
{
     ...
     *
     * @var \NINA\Database\Schema\Grammars\Grammar
     */
     ...
     *
     * @var \NINA\Database\DatabaseTransactionsManager
     */
     ...
     *
     * @return \NINA\Database\Schema\Grammars\Grammar|null
     */
     ...
     *
     * @return \NINA\Database\Schema\Builder
     */
     ...
     *
     * @param  \Closure|\NINA\Database\Query\Builder|\Illuminate\Contracts\Database\Query\Expression|string  $table
     ...
     * @return mixed
     *
     * @throws \NINA\Database\MultipleColumnsSelectedException
     */
     ...
     * @return mixed
     *
     * @throws \NINA\Database\QueryException
     */
     ...
     *
     * @param  \NINA\Database\QueryException  $e
     * @param  string  $query
     * @param  array  $bindings
     * @param  \Closure  $callback
     * @return mixed
     ...
     * @return mixed|false
     *
     * @throws \NINA\Database\LostConnectionException
     */
     ...
     *
     * @param  \NINA\Database\Query\Grammars\Grammar  $grammar
     * @return $this
     */
     ...
     *
     * @return \NINA\Database\Schema\Grammars\Grammar
     */
     ...
     *
     * @param  \NINA\Database\Schema\Grammars\Grammar  $grammar
     * @return $this
     */
     ...
     *
     * @param  \NINA\Database\Query\Processors\Processor  $processor
     * @return $this
     */
     ...
     *
     * @param  \NINA\Database\DatabaseTransactionsManager  $manager
     * @return $this
     */
