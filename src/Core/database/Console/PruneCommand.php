...
use NINA\Database\Eloquent\MassPrunable;
use NINA\Database\Eloquent\Prunable;
use NINA\Database\Eloquent\SoftDeletes;
use NINA\Database\Events\ModelPruningFinished;
use NINA\Database\Events\ModelPruningStarting;
use NINA\Database\Events\ModelsPruned;
