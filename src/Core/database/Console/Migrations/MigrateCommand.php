...
namespace NINA\Database\Console\Migrations;

use Illuminate\Console\ConfirmableTrait;
use Illuminate\Contracts\Console\Isolatable;
use Illuminate\Contracts\Events\Dispatcher;
use NINA\Database\Events\SchemaLoaded;
use NINA\Database\Migrations\Migrator;
use NINA\Database\SQLiteDatabaseDoesNotExistException;
...
class MigrateCommand extends BaseCommand implements Isolatable
{
     ...
     *
     * @var \NINA\Database\Migrations\Migrator
     */
    protected $migrator;
     ...
     *
     * @param  \NINA\Database\Migrations\Migrator  $migrator
