...
use NINA\Database\Eloquent\Concerns\HasUlids;
use NINA\Database\Query\Expression;
use NINA\Database\Schema\Grammars\Grammar;
use NINA\Database\Schema\Grammars\MySqlGrammar;
...
class Blueprint
{
     ...
     *
     * @var \NINA\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     * @return \NINA\Database\Schema\IndexDefinition
     */
     ...
     * @param  string|array  $columns
     * @param  string|null  $name
     * @return \NINA\Database\Schema\ForeignKeyDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \NINA\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \NINA\Database\Schema\ForeignIdColumnDefinition
     */
     ...
     *
     * @param  \NINA\Database\Schema\ColumnDefinition  $definition
     * @return \NINA\Database\Schema\ColumnDefinition
     */
