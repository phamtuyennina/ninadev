...
namespace NINA\Database\Concerns;

use Illuminate\Container\Container;
use NINA\Database\Eloquent\Builder;
use NINA\Database\MultipleRecordsFoundException;
...
trait BuildsQueries
{
     ...
     * @return \NINA\Database\Eloquent\Model|object|static|null
     */
     ...
     *
     * @param  \NINA\Database\Query\Builder|\NINA\Database\Eloquent\Builder  $builder
