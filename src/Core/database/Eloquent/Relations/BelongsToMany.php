...
use NINA\Database\Eloquent\ModelNotFoundException;
use NINA\Database\Eloquent\Relations\Concerns\AsPivot;
use NINA\Database\Eloquent\Relations\Concerns\InteractsWithDictionary;
use NINA\Database\Eloquent\Relations\Concerns\InteractsWithPivotTable;
use NINA\Database\Query\Grammars\MySqlGrammar;
...
class BelongsToMany extends Relation
{
     ...
     *
     * @param  \NINA\Database\Eloquent\Builder|null  $query
     * @return $this
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \Illuminate\Support\Collection|\NINA\Database\Eloquent\Model
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \NINA\Database\Eloquent\Model|\NINA\Database\Eloquent\Collection|null
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \NINA\Database\Eloquent\Model|\NINA\Database\Eloquent\Collection
     *
     ...
     * @return \NINA\Database\Eloquent\Model|\NINA\Database\Eloquent\Collection|mixed
     */
