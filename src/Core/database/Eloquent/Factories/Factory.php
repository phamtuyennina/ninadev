...
namespace NINA\Database\Eloquent\Factories;

use Closure;
use Faker\Generator;
use Illuminate\Container\Container;
use Illuminate\Contracts\Foundation\Application;
use NINA\Database\Eloquent\Collection as EloquentCollection;
use NINA\Database\Eloquent\Model;
use NINA\Database\Eloquent\SoftDeletes;
...
/**
 * @template TModel of \NINA\Database\Eloquent\Model
 *
 * @method $this trashed()
 */
abstract class Factory
{
     ...
     *
     * @var class-string<\NINA\Database\Eloquent\Model|TModel>
     */
    protected $model;
     ...
     *
     * @param  (callable(array<string, mixed>): array<string, mixed>)|array<string, mixed>  $attributes
     * @param  \NINA\Database\Eloquent\Model|null  $parent
     ...
     *
     * @param  (callable(array<string, mixed>): array<string, mixed>)|array<string, mixed>  $attributes
     * @return \NINA\Database\Eloquent\Model|TModel
     */
     ...
     * @return \NINA\Database\Eloquent\Collection<int, \NINA\Database\Eloquent\Model|TModel>
     */
     ...
     * @param  (callable(array<string, mixed>): array<string, mixed>)|array<string, mixed>  $attributes
     * @param  \NINA\Database\Eloquent\Model|null  $parent
     * @return \NINA\Database\Eloquent\Collection<int, \NINA\Database\Eloquent\Model|TModel>|\NINA\Database\Eloquent\Model|TModel
     */
     ...
     * @param  \NINA\Database\Eloquent\Model|null  $parent
     * @return \Closure(): (\NINA\Database\Eloquent\Collection<int, \NINA\Database\Eloquent\Model|TModel>|\NINA\Database\Eloquent\Model|TModel)
     */
     ...
     *
     * @param  (callable(array<string, mixed>, \NINA\Database\Eloquent\Model|null): array<string, mixed>)|array<string, mixed>  $state
     * @return static
     */
     ...
     *
     * @param  \NINA\Database\Eloquent\Factories\Factory  $factory
     ...
     *
     * @param  \NINA\Database\Eloquent\Factories\Factory|\Illuminate\Support\Collection|\NINA\Database\Eloquent\Model|array  $factory
     ...
     *
     * @param  \NINA\Database\Eloquent\Factories\Factory|\NINA\Database\Eloquent\Model  $factory
     * @param  string|null  $relationship
     * @return static
     */
     ...
     *
     * @param  \NINA\Database\Eloquent\Model|\Illuminate\Support\Collection|array  $model
     * @return static
     */
     ...
     * @return \NINA\Database\Eloquent\Model|null
     */
     ...
     *
     * @param  \Closure(\NINA\Database\Eloquent\Model|TModel): mixed  $callback
     * @return static
     */
     ...
     *
     * @return class-string<\NINA\Database\Eloquent\Model|TModel>
     */
     ...
     *
     * @param  callable(self): class-string<\NINA\Database\Eloquent\Model|TModel>  $callback
     * @return void
     */
     ...
     *
     * @param  class-string<\NINA\Database\Eloquent\Model>  $modelName
     * @return \NINA\Database\Eloquent\Factories\Factory
     */
     ...
     *
     * @param  callable(class-string<\NINA\Database\Eloquent\Model>): class-string<\NINA\Database\Eloquent\Factories\Factory>  $callback
     * @return void
     */
     ...
     *
     * @param  class-string<\NINA\Database\Eloquent\Model>  $modelName
     * @return class-string<\NINA\Database\Eloquent\Factories\Factory>
     */
