...
class Collection extends BaseCollection implements QueueableCollection
{
     ...
     *
     * @param  array<array-key, (callable(\NINA\Database\Eloquent\Builder): mixed)|string>|string  $relations
     * @return $this
     */
     ...
     *
     * @param  \NINA\Database\Eloquent\Collection  $models
     * @param  array  $path
     * @return void
     */
     ...
     * @param  array<array-key, (callable(\NINA\Database\Eloquent\Builder): mixed)|string>  $relations
     * @return $this
     */
