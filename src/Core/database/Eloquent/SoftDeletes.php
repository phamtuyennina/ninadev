...
/**
 * @method static \NINA\Database\Eloquent\Builder|\NINA\Database\Query\Builder withTrashed(bool $withTrashed = true)
 * @method static \NINA\Database\Eloquent\Builder|\NINA\Database\Query\Builder onlyTrashed()
 * @method static \NINA\Database\Eloquent\Builder|\NINA\Database\Query\Builder withoutTrashed()
 */
trait SoftDeletes
{
    /**
