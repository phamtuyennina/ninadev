...
use NINA\Database\Eloquent\Casts\AsArrayObject;
use NINA\Database\Eloquent\Casts\AsCollection;
use NINA\Database\Eloquent\Casts\AsEncryptedArrayObject;
use NINA\Database\Eloquent\Casts\AsEncryptedCollection;
use NINA\Database\Eloquent\Casts\AsEnumArrayObject;
use NINA\Database\Eloquent\Casts\AsEnumCollection;
use NINA\Database\Eloquent\Casts\Attribute;
use NINA\Database\Eloquent\Casts\Json;
use NINA\Database\Eloquent\InvalidCastException;
use NINA\Database\Eloquent\JsonEncodingException;
use NINA\Database\Eloquent\MissingAttributeException;
use NINA\Database\Eloquent\Relations\Relation;
use NINA\Database\LazyLoadingViolationException;
...
trait HasAttributes
{
     ...
     * @return null
     *
     * @throws \NINA\Database\Eloquent\MissingAttributeException
     */
     ...
     * @return bool
     *
     * @throws \NINA\Database\Eloquent\InvalidCastException
     */
