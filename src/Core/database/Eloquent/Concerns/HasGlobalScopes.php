...
use Closure;
use NINA\Database\Eloquent\Attributes\ScopedBy;
use NINA\Database\Eloquent\Scope;
...
trait HasGlobalScopes
{
     ...
     *
     * @param  \NINA\Database\Eloquent\Scope|\Closure|string  $scope
     * @param  \NINA\Database\Eloquent\Scope|\Closure|null  $implementation
     * @return mixed
     *
     ...
     *
     * @param  \NINA\Database\Eloquent\Scope|string  $scope
     * @return \NINA\Database\Eloquent\Scope|\Closure|null
     */
