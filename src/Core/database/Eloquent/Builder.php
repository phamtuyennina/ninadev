...
use NINA\Database\Eloquent\Concerns\QueriesRelationships;
...
use NINA\Database\RecordsNotFoundException;
use NINA\Database\UniqueConstraintViolationException;
use Illuminate\Support\Arr;
use Illuminate\Support\Str;
use Illuminate\Support\Traits\ForwardsCalls;
use NINA\Database\Traits\Eloquent\CommitQueryMethod;
use NINA\Database\Traits\Eloquent\Pagination;
use ReflectionClass;
 ...
 *
 * @mixin \NINA\Database\Query\Builder
 */
class Builder implements BuilderContract
{
     ...
     *
     * @var \NINA\Database\Query\Builder
     */
    protected $query;
     ...
     * @return \NINA\Database\Eloquent\Model|static
     */
     ...
     * @param  \NINA\Database\Eloquent\Scope|\Closure  $scope
     * @return $this
     */
     ...
     *
     * @param  \NINA\Database\Eloquent\Scope|string  $scope
     * @return $this
     */
     ...
     * @param  mixed  $value
     * @param  string  $boolean
     * @return \NINA\Database\Eloquent\Model|static|null
     */
     ...
     *
     * @param  array  $items
     * @return \NINA\Database\Eloquent\Collection
     */
     ...
     * @return \NINA\Database\Eloquent\Model|\NINA\Database\Eloquent\Collection|static[]|static|null
     */
     ...
     * @param  mixed  $id
     * @param  array|string  $columns
     * @return \NINA\Database\Eloquent\Model|\NINA\Database\Eloquent\Collection|static|static[]
     *
     * @throws \NINA\Database\Eloquent\ModelNotFoundException<\NINA\Database\Eloquent\Model>
     */
     ...
     * @return \NINA\Database\Eloquent\Model|\NINA\Database\Eloquent\Collection|static[]|static|mixed
     */
     ...
     * @param  \Closure|array|string  $columns
     * @param  \Closure|null  $callback
     * @return \NINA\Database\Eloquent\Model|static|mixed
     */
     ...
     *
     * @param  array|string  $columns
     * @return \NINA\Database\Eloquent\Collection|static[]
     */
     ...
     *
     * @param  string  $name
     * @return \NINA\Database\Eloquent\Relations\Relation
     */
     ...
     *
     * @param  array  $attributes
     * @return \NINA\Database\Eloquent\Model|$this
     */
