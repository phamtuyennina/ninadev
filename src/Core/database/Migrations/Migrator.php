...
namespace NINA\Database\Migrations;
...
use NINA\Database\Events\MigrationEnded;
use NINA\Database\Events\MigrationsEnded;
use NINA\Database\Events\MigrationsStarted;
use NINA\Database\Events\MigrationStarted;
use NINA\Database\Events\NoPendingMigrations;
...
class Migrator
{
     ...
     *
     * @var \NINA\Database\Migrations\MigrationRepositoryInterface
     */
     ...
     *
     * @var array<string, \NINA\Database\Migrations\Migration|null>
     */
     ...
     *
     * @param  \NINA\Database\Migrations\MigrationRepositoryInterface  $repository
     ...
     *
     * @return \NINA\Database\Migrations\MigrationRepositoryInterface
     */
