...
use NINA\Core\Cart\Contracts\Buyable;
use NINA\Core\Cart\Contracts\InstanceIdentifier;
...
class Cart
{
    ...
    public function content()
    {
        ...
        return $this->session->get($this->instance)['cart'][Str::afterLast($this->instance,'.')];
    }
    ...
    protected function getContent()
    {
        if ($this->session->has($this->instance)) {
            ...
            return $content['cart'][Str::afterLast($this->instance,'.')];
        }
        return new Collection();
    }
